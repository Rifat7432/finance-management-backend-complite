...
const sendEmail = (values) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.logger.info(colors_1.default.green(`✅ [Rehu App] Email sent successfully: ${data.id}`));
    }
    catch (error) {
        logger_1.errorLogger.error(colors_1.default.red('[Rehu App] Email Error:'), error);
    }
});
...
const sendEmailForAdmin = (values) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.logger.info(colors_1.default.green(`✅ [Rehu App] Admin email sent: ${data.id}`));
    }
    catch (error) {
        logger_1.errorLogger.error(colors_1.default.red('[Rehu App] Admin Email Error:'), error);
    }
});
