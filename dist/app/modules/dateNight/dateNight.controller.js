...
const createDateNight = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const _a = req.body, { sendEmilNotification } = _a, rest = __rest(_a, ["sendEmilNotification"]);
    const result = yield dateNight_service_1.DateNightService.createDateNightToDB(user.id, rest, sendEmilNotification);
